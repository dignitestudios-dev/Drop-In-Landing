...
const Hero = () => {
  ...
  return (
    <div className=" min-h-screen  flex flex-col justify-center items-center  md:py-8  relative mb-20">
      ...
      <div className="flex flex-col  absolute top-20  justify-center px-6">
        <h2 className="text-white text-[44px] lg:text-[65px] font-[500] lg:leading-[101px] text-center ">
