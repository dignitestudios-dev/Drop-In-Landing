...
const BelowFeedBack = () => {
  return (
    <div className="p-6 lg:p-20">
      <div className="w-full flex flex-col pt-10 items-center justify-center gap-2 lg:gap-4 bg-[#1313138A] border-[1px] border-[#212121] overflow-hidden rounded-[30px]">
        ...
        <p className="text-[16px] font-[400] text-[#D6D6D6] px-20 md:px-32  lg:px-72 text-center">
